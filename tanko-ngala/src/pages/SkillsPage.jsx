...
function Skills() {
  return (
    ...
    >
      <h2 className="sm:text-3xl md:text-5xl lg:text-7xl  font-bold text-center  mb-10">
        Skills & Tools
      </h2>

      <div className="grid sm:grid-col-1 lg:grid-cols-2 gap-15 max-w-6xl mx-auto">
        {/* Front-End Development */}
        <div className="bg-green-800 rounded-2xl p-6 shadow-md hover:shadow-xl transition-all duration-300">
        ...
        {/* Tools & Workflow */}
        <div className="bg-green-600 rounded-2xl p-6 shadow-md hover:shadow-xl transition-all duration-300">
          <div className="flex items-center gap-3 mb-4">
      ...
      <p className=" md:text-xl sm:text-lg text-base text-center text-gray-200 mt-12 text-sm">
