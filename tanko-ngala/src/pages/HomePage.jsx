          ...
          className="font-poppins, text-gray-200 bg-black w-full min-h-screen ">
            <Navbar />
               <div className=" gap-x-8 flex flex-col md:flex-row items-center justify-center  items-center w-full">
                ...
                <Link to="/projects" className="flex items-center text-lg font-bold px-4 py-2 mb-6 bg-purple-700 rounded-lg hover:bg-blue-500 transition ">✅ View my work</Link>
                <Link to="/contact" className="flex items-center text-lg mb-6  font-bold  gap-2 px-4 py-2 bg-purple-700 rounded-lg transition hover:bg-blue-500">
                <Mail className="w-8 h-8"/>
                Contact Me
                </Link>
                <a href="/Tanko_Fabrice_resume.pdf" download="Tanko_Fabrice_resume.pdf"
                className="flex items-cemter gap-4 bg-purple-700 px-2 py-2 rounded-lg hover:bg-blue-500 font-semibold">
