...
function Home(){
    ...
    return(
        <div
         style={{ backgroundImage: `url(${background})` }} className="font-poppins, text-black bg-cover bg-no-repeat bg-center w-full min-h-screen ">
            <Navbar />
               <div className=" gap-x-8 flex flex-col md:flex-row items-center justify-center  items-center w-full">
                ...
                <Link to="/projects" className="flex items-center text-lg font-bold px-4 py-2 mb-6 bg-cyan-600 rounded-3xl transition ">View my work</Link>
                <Link to="/contact" className="flex items-center text-lg mb-20  font-bold  gap-2 px-4 py-2 bg-cyan-600 rounded-3xl transition hover:bg-purple-8000">
